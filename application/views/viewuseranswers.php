...
<div id="container" class="container" style="width:100%">
 ...
 <div id="category-top" style="margin-bottom:2em;"> 
     <div> 
   Questions Answers By :<?php echo $userdetail ->user_name; ?>
             
   </div> 
<!--     <div style="float:right">
     <span>Total Questions Answered:<?php //echo $totalanswered; ?></span>
...
<?php //echo $anslist; 
foreach ($useranswer_list as $row):?> 
 <tr> 
   ...
   <td><?php echo $row->sum_answers; ?></td> 
